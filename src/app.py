...
# Additional sports activities
    "Soccer Team": {
        "description": "Join the varsity soccer team and compete in interschool matches",
    ...
    # Artistic activities
    "Drama Club": {
        "description": "Explore acting, directing, and stage production",
    ...
    "Debate Team": {
        ...
        "max_participants": 14,
        "participants": ["david@mergington.edu", "lucy@mergington.edu"]
    },
    "Science Olympiad": {
